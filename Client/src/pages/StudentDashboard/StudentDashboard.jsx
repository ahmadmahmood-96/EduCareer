...
import { faGraduationCap, faCheckCircle, faClipboard, faQuestionCircle,faHistory ,faCertificate} from '@fortawesome/free-solid-svg-icons';
    ...
    <div className="relative flex flex-row ">
      ...
      <div className="fixed left-0 top-18 h-full ">
        ...
        <SidebarItem icon={<FontAwesomeIcon icon={faGraduationCap} />} text="Courses" to="/studentdashboard" />
          ...
          <SidebarItem icon={<FontAwesomeIcon icon={faCheckCircle} />} text="Grades" to="/studentdashboard/grades"/>
