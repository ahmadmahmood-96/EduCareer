...
function QuizResult(props) {
    const { score, totalScore, showLoginButton, showHomeButton } = props;
           ...
           <div className="show-score text-4xl font-bold text-center">
            ...
            {showLoginButton && (
                <button
                    ...
                    className="bg-purple-600 text-white px-6 py-3 rounded-md shadow-md font-bold text-lg transition duration-200 hover:bg-purple-700 ml-4"
                >
                    Go to Login
                </button>
            )}
